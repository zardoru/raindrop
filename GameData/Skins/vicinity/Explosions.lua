...
Explosions.HitFrames = 12
Explosions.HitScale = 0.5

Explosions.HoldFramerate = 60
Explosions.HoldFrames = 90
Explosions.HoldScale = 0.5

function Explosions.ObjectPosition(Atlas, i, Scale)
...
function Explosions.Init()
	...
	for i = 1, Channels do
		...
		Explosions.ObjectPosition(Explosions.HitAtlas, i, Explosions.HitScale)
		...
		Explosions.ObjectPosition(Explosions.HoldAtlas, i, Explosions.HoldScale)

...
public:
    ...
    void LoadSongDCFromDir(std::filesystem::path songPath, std::vector<Game::dotcur::Song*> &VecOut);
    void GetSongListDC(std::vector<Game::dotcur::Song*> &OutVec, std::filesystem::path Dir);

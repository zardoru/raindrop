...
void NoteLoaderSSC::LoadObjectsFromFile(const std::filesystem::path &filename, Song *Out)
{
    ...
    std::unique_ptr<Difficulty> Diff = nullptr;
...
void NoteLoaderSM::LoadObjectsFromFile(const std::filesystem::path &filename, Song *Out)
{
